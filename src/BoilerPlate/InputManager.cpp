...
InputManager::InputManager(){
	was_up_key_pressed = false;
	was_left_key_pressed = false;
	was_right_key_pressed = false;
	was_space_key_pressed =  false;
	was_d_key_pressed = false;
	was_f_key_pressed = false;
	was_m_key_pressed = false;
	was_l_key_pressed = false;
}
